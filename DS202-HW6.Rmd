...
One question I am curious about with this data is the relationship between finances, partyid, and sex

I have ommited all NA's as I am attempting to compare those who did answer the questions. Our data shows that regardless of political partyid, women make less than men on average, and republicans on average make more than democrats, independents, and a sampling of other parties.
```{r}
#degree and health to happiness
na.omit(happy) %>% group_by(partyid, sex) %>% summarise(
  m.finrela = mean(as.numeric(finrela), na.rm=TRUE)) %>%
